...
let hamburger = document.getElementsByClassName('ham-nav')[0];
console.log(nav_links, hamburger);
...
function create_form_html(){
    ...
    let form_html = "<form autocomplete='off' action='/search/' method='get' class='form' style='max-width:170px;box-shadow: 0 0 1em 0.1em rgb(100 132 179);'>" + 
